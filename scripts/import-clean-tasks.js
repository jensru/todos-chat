...
/**
 * Bereinigter Import aller Tasks aus Git-Backup
 * Filtert ungültige Daten und importiert nur gültige Tasks
 */
...
async function importAllTasks() {
  try {
    console.log('🚀 Starte bereinigten Task-Import...');
    ...
    console.log(`✅ ${validTasks.length} gültige Tasks nach Bereinigung`);
